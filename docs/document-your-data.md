...
| `curator`                  | object            | Agent IRI                 | Required                         | Required                     | Required                | Required     | —        | At least include agent(s) responsible for curating the metadata entry of the resource in the knowledge base. Also agents curating the data itself can be added.                                                                                                                                         |
...
| `label`                    | annotation        | Literal                   | Optional                         | Required                     | Required                | Optional     | Optional | Short human-readable label.                                                                                                                                                                                       |
...
| `title`                    | annotation        | Literal                   | Required                         | Optional                     | Optional                | Required     | —        | Human-readable title of the resource. For classes, `label` is preferred.                                                                                                                             |
...
|---|---|---|---|---|
| https://example.org/dataset/tox-001 | pink:Dataset | My toxicity dataset | Measurements from in vitro assay. | https://orcid.org/0000-0000-0000-0001 |
