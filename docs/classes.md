...
| dcterms:RightsStatement  | A statement about the intellectual property rights (IPR) held in or over a resource, a legal document giving official permission to do something with a resource, or a statement about access rights. | Use one of the pre-defined individuals of this class defined by EU: rights:PUBLIC, rights:NON_PUBLIC, rights:CONFIDENTIAL, rights:RESTRICTED, rights:SENSITIVE |
