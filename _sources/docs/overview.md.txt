...
It adheres to the recommendations specified by [DCAT-AP 3.0.1] as implemented in [Tripper],
...
However, the taxonomy is intentionally weakly axiomatized in order to facilitate alignment to different popular top-level ontologies, like [EMMO], [DOLCE] and [BFO].
